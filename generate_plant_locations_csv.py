...
from tasks.tables.plant_zipcodes.generate import GeneratePlantZipcodesCsv
...
if __name__ == "__main__":
    ...
    tasks_to_clear = [
        GeneratePlantZipcodesCsv(plants_filename=plants_filename),
    ]
    ...
    task = GeneratePlantZipcodesCsv(plants_filename=plants_filename)
