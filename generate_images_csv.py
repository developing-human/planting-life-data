...
import sys
import luigi
from tasks.tables.images.generate import GenerateImagesCsv, GenerateImagesWithoutHumanOverridesCsv
...
if __name__ == "__main__":
    ...
    task = GenerateImagesCsv(plants_filename=plants_filename)
